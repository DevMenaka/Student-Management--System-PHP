...
<body style="background-color: #000000;background-image: linear-gradient(90deg,#000000 0%,#9FACE6 100%);">
                            ...
                            <div class="row g-4 justify-content-center">
                                ...
                                <div class="12" id="signInBox">
                                    <div class="row justify-content-center">
                                        <div class="col-10 border-bottom border-light mb-5">
                                            <p class="title2 text-light">Teacher Log In</p>
                                        </div>
                                        <?php
                                        ...
                                        <div class="col-10 mt-2">
                                            ...
                                            <input type="text" class="form-control bg-transparent text-white" id="un" value="<?php echo $user;?>"/>
                                        </div>
                                        <div class="col-10 mt-2">
                                            <label class="form-label fs-5 text-white">Password</label>
                                            <input type="password" class="form-control bg-transparent text-white" id="pw" value="<?php echo $password;?>"/>
                                        </div>
                                        ...
                                        <div class="col-5 text-end mt-2">
                                            <a href="#" class="link-info" ondblclick="sforgotPassword();">Forgot Password</a>
                                        </div>

                                        <div class="col-10 col-lg-10 d-grid mt-2">
                                            <button class="btn btn-primary" ondblclick="TeacherLogin();">Log In</button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="12 d-none" id="resetPw">
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="col-10 col-lg-10 d-grid mt-2">
                                            <button class="btn btn-success fw-bold"onclick="resetSpw();">Reset Password</button>
                                        </div>
                                        <div class="col-10 col-lg-10 d-grid mt-2">
                                            <a href="studentSignin.php" class="btn btn-outline-danger fw-bold">Back to Login</a>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="modal" tabindex="-1" id="vModel">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Teacher Veryfication</h5>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary" onclick="teacherVedrfy();" >Verify</button>
                        </div>
                    </div>
                </div>
            </div>
