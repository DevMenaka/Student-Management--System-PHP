                                ...
                                <div class="12" id="signInBox">
                                    <div class="row justify-content-center">
                                        <div class="col-10 border-bottom border-light mb-5">
                                            <p class="title2 text-light">Student Log In</p>
                                        </div>
                                        <?php
                                        ...
                                        <div class="col-10 mt-2">
                                            ...
                                            <input type="email" class="form-control bg-transparent text-white" id="e1" value="<?php echo $email;?>"/>
                                        </div>
                                        <div class="col-10 mt-2">
                                            <label class="form-label fs-5 text-white">Password</label>
                                            <input type="password" class="form-control bg-transparent text-white" id="pw2" value="<?php echo $password;?>"/>
                                        </div>
                                        ...
                                        <div class="col-10 col-lg-10 d-grid mt-2">
                                            <button class="btn btn-primary" ondblclick="SsignIn();">Log In</button>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Student Veryfication</h5>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary" onclick="studentVedrfy();" >Verify</button>
                        </div>
                    </div>
                </div>
            </div>
